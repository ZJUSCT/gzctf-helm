...
{{- printf "minio.s3://serviceUrl=%s-minio:9000;accessKey=%s;secretKey=%s;bucket=%s;region=us-east-1" .Release.Name .Values.minio.rootUser .Values.minio.rootPassword (index .Values.minio.buckets 0).name -}}
{{- else -}}
{{- "" -}}
{{- end -}}
{{- end }}
